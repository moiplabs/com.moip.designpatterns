...
class MoIPInstrucaoUnicaStrategy extends MoIPAbstractHttpStrategy {
	/**
	 * @param	MoIP $context
	...
	public function execute( MoIP $context ) {
		...
		$this->createInstrucaoUnicaComponent( $context , $enviarInstrucaoComponent );

		return $this->request( $enviarInstrucaoComponent )->getContent();
	}

	protected function createInstrucaoUnicaComponent( MoIP $context , MoIPComponent $enviarInstrucaoComponent ) {
		...
		return $instrucaoUnicaComponent;
	}
}